...
function Card() {
    ...
    const cardInfo = [
        ...
        { id: "finishchecker", text: "Finish Checker", handleShow: handleShow7, handleClose: handleClose7, show: showModal7, modalTitle: "Finish Checker", modalText1: "My favorite hobby is building guitars. Like many other hobbyists, I lack constant access to a temperature controlled spray area. I wanted to create an application for myself and others that would indicate whether or not weather conditions are correct for spraying the nitrocellulose finish commonly found on guitars.", modalText2: "This application is built in React, with the Weather API from OpenWeather providing the up-to-date information. Finish Checker uses Geolocation to get the weather of the user's current location. If users choose to opt out of Geolocation, they may also search for their zip code.", img: FinishCheckerScreenshot, project: "https://finishchecker.com/", github: "https://github.com/adamalcantara/finish_checker_react" },
